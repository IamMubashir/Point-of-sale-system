     ...
     <div className='w-[500px] bg-[#262626] p-4 rounded-lg mb-4'>
          ...
          <div className='flex items-center justify-between w-[100%]'>
            ...
            <div className='flex flex-col items-end gap-2'>
                <p className='bg-green-30 text-green-600 bg-[#2e4a40]  px-2 py-1 rounded-lg'><FaCheckDouble className='inline mr-2'/>Ready</p>
          ...
          <div className='flex items-center justify-between mt-4'>
            ...
            <p className='text-[#f5f5f5] text-lg font-semibold'>Rs 250.00</p>
          </div>
        </div>
  )
}
