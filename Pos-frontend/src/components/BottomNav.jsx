...
const BottomNav = () => {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
      ...
      <button className="flex items-center justify-center text-[#ababab] item-center w-[200px]">
      ...
      <button className="absolute bottom-6 bg-[#f6b100] text-[#f5f5f5] rounded-full p-3 item-center"><BiSolidDish size={30} /></button>
    </div>
  );
};
